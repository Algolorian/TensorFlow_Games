...
# npy_arr = np.concatenate((npy_arr, np.load('DB_Files/npy_arr.npy', allow_pickle=True)))
# bln_arr = np.concatenate((bln_arr, np.load('DB_Files/bln_arr.npy')))


np.save(f"DB_Files/npy_arr", npy_arr)
np.save(f"DB_Files/bln_arr", bln_arr)
